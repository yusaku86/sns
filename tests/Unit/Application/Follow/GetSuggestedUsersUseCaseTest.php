...
it('おすすめユーザーが空の場合はキャッシュに保存しない', function () {
    $repository = mock(FollowRepositoryInterface::class);
    $repository->shouldReceive('getSuggestedUsers')->with('uuid-1', 5)->once()->andReturn([]);
    $repository->shouldNotReceive('getFollowingIds');
